...
public class UDPTrackerClient extends TrackerClient {
    ...
    public boolean equals(Object o) {
        ...
        UDPTrackerClient that = (UDPTrackerClient) o;

        if (connectionId != that.connectionId) return false;
        if (stop != that.stop) return false;
        if (transactionId != that.transactionId) return false;
        if (address != null ? !address.equals(that.address) : that.address != null) return false;
        if (connectionExpiration != null ? !connectionExpiration.equals(that.connectionExpiration) : that.connectionExpiration != null)
            return false;
    ...
    public int hashCode() {
        ...
        result = 31 * result + (connectionExpiration != null ? connectionExpiration.hashCode() : 0);
